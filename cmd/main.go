...
import (
	...
	"github.com/kcddhaka/kcd2024-deployment-watcher/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f9aafff7.operators.kcddhaka.org",
	...
	if err = (&controller.DeploymentWatcherReconciler{
